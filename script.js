...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Замените значения этих переменных на реальные URL после публикации
  const courseUrl = '#'; // ссылка на программу корпоративного курса
  const telegramUrl = '#'; // ссылка на Telegram контакт
